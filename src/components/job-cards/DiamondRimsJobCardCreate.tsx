            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  type="button"
                  onClick={addPart}
                  className="px-4 py-2 bg-gradient-to-r from-purple-50 to-purple-100 text-purple-700 rounded-xl text-sm font-medium hover:from-purple-100 hover:to-purple-200 shadow-sm border border-purple-200 hover:border-purple-300 transition-all"
                >
              ...
              <div className="space-y-4">
                {formData.partsUsed.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 mb-4">Add parts that will be used for rim services</p>
                  </div>
                ) : (
                          ...
                          <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                            <td className="py-3 px-4">
                              <select
                                ...
                                className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-1 focus:ring-purple-200 focus:outline-none bg-white appearance-none min-w-[120px]"
                              >
                            ...
                            <td className="py-3 px-4">
                              <input
                                ...
                                className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-1 focus:ring-purple-200 focus:outline-none min-w-[200px]"
                              />
                            </td>
                            <td className="py-3 px-4">
                              <input
                                ...
                                min="1"
                                className="w-20 px-3 py-2 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-1 focus:ring-purple-200 focus:outline-none"
                              />
                            </td>
                            <td className="py-3 px-4">
                              <input
                                ...
                                min="0"
                                step="0.01"
                                className="w-32 px-3 py-2 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-1 focus:ring-purple-200 focus:outline-none"
                              />
                            </td>
                        ...
                        <div className="w-64 space-y-3">
                          <div>
                            ...
                            <input
                              ...
                              min="0"
                              step="0.01"
                              className="w-full px-3 py-2 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-1 focus:ring-purple-200 focus:outline-none"
                            />
                          </div>
                          ...
                          <div className="pt-3 border-t border-gray-200">
                            <div className="flex justify-between font-semibold">
                              ...
                              <span className="text-purple-600">{jobCardService.formatCurrency(totals.totalCost)}</span>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border p-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        All Diamond Rimz services come with a {formData.warrantyPeriod} warranty covering workmanship. 
                        Warranty does not cover damage from accidents, misuse, or improper installation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    <input
                      type="checkbox"
                      id="acceptWarrantyTerms"
                      checked={formData.acceptWarrantyTerms}
                      onChange={(e) => handleInputChange('acceptWarrantyTerms', e.target.checked)}
                      className="mt-1"
                      required
                    />
                    <label htmlFor="acceptWarrantyTerms" className="text-sm text-gray-700">
                      I understand and accept the warranty terms and conditions *
                    </label>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="acceptTerms" className="text-sm text-gray-700">
                      I accept the Terms and Conditions of Diamond Rimz LTD *
                    </label>
                  </div>
                </div>
