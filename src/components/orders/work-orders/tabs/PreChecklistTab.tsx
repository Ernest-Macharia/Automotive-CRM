...
import {
  ...
  FileCheck, ShieldCheck, Users, Search
} from 'lucide-react';
...
export default function PreChecklistTab({ 
  ...
  const handleCreateStandaloneChecklist = () => {
    router.push('/pre-checklist/create?source=workorder');
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={handleCreateStandaloneChecklist}
            disabled={isTransitioning}
            ...
            title="Search and select a different client before creating checklist"
          >
            <Search className="h-4 w-4" />
            Search Client
          </button>
          <div className="hidden xl:flex items-center gap-2 text-sm text-gray-500 ml-2">
