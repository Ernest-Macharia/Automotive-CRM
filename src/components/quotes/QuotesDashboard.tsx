...
export default function QuotesDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/50 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Create, manage, and track customer quotes</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/quotes/create"
              className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl"
            >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          {/* <div className="text-sm text-gray-600 mt-1">
                            Opportunity: {quote.opportunityId.substring(0, 10)}...
                          </div> */}
                          {quote.notes && (
