...
export default function BlueprintDetailsPage({ blueprintId }: BlueprintDetailsPageProps) {
  ...
  useEffect(() => {
    if (blueprintId) {
      ...
      console.error('Blueprint ID is undefined');
      showToast('Invalid blueprint ID', 'error');
      router.push('/settings/blueprints');
    }
  }, [blueprintId, router, showToast]);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-blue-100 mt-1">View workflow template and process stages</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm sticky top-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 capitalize">{blueprint.module}</p>
                </div>
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-gradient-to-br from-white to-blue-50 border border-blue-200 rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                      <div>
                  ...
                  <div className="bg-gradient-to-br from-white to-green-50 border border-green-200 rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                      <div>
                  ...
                  <div className="bg-gradient-to-br from-white to-purple-50 border border-purple-200 rounded-2xl p-6">
                    <div className="flex items-center justify-between">
                      <div>
            ...
            {activeTab === 'stages' && (
              <div className="space-y-6">
                {blueprint.stages
                  ...
                  .map((stage, index) => (
                    <div key={stage.id || index} className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                      {/* Stage Header */}
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-3 mt-2">
                                <span className="text-sm text-gray-600">Order: {stage.order}</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full">
            ...
            <p className="text-gray-700 mb-6">
              Are you sure you want to delete <strong>{blueprint.name}</strong>?
