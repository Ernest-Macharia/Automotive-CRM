            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:block relative">
                ...
                <input
                  ...
                  className="w-64 pl-10 pr-4 py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl text-sm text-white placeholder-blue-100/80 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent"
                />
                {searchQuery && (
                  <button
                    onClick={() => setSearchQuery('')}
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 p-1 text-blue-200 hover:text-white"
                  >
                    <X className="h-4 w-4" />
                  </button>
                )}
        ...
        <div className="bg-white/80 backdrop-blur-sm border-b border-blue-100">
          <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <button
              ...
              className="flex items-center gap-2 text-sm text-blue-600 hover:text-blue-800 hover:bg-blue-50 px-3 py-2 rounded-lg transition-colors"
            >
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {pathname !== '/settings' && (
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                {loading ? (
                  <div className="h-16 w-16 bg-gradient-to-r from-blue-200 to-purple-200 rounded-xl animate-pulse"></div>
                ) : (
                ...
                <div>
                  {loading ? (
                    <>
                      <div className="h-7 w-48 bg-gray-300/50 rounded mb-3"></div>
              ...
              {loading ? (
                <div className="h-8 w-24 bg-gray-300/50 rounded-full"></div>
              ) : (
                <div className="px-3 py-1 bg-gradient-to-r from-blue-500/10 to-purple-500/10 text-blue-700 text-sm font-medium rounded-full border border-blue-200">
                  156 items
                </div>
              )}
            </div>
        ...
        {pathname === '/settings' && (
          <div className="mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {[
                  ...
                  return (
                    <div 
                      key={index}
                      className="bg-white/80 backdrop-blur-sm rounded-2xl p-5 border border-blue-100/50 hover:shadow-lg transition-all group"
                    >
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        <div className={`p-3 rounded-xl bg-gradient-to-r ${stat.gradient}/10 group-hover:scale-110 transition-transform`}>
                          <Icon className={`h-6 w-6 ${stat.gradient.includes('blue') ? 'text-blue-600' : 
                                            ...
                                            stat.gradient.includes('purple') ? 'text-purple-600' : 'text-amber-600'}`} />
                        </div>
                      </div>
            ...
            {/* Category Filters with Skeleton */}
            <div className="mb-6">
        ...
        {pathname === '/settings' ? (
          <>
            {/* Featured Settings with Skeleton */}
                    ...
                    {featuredItems.map((item) => {
                      ...
                      return (
                        <Link
                          key={item.id}
                          href={item.href}
                          className={`group relative bg-gradient-to-br from-white to-blue-50/30 border-2 rounded-2xl p-6 hover:shadow-xl transition-all duration-300 overflow-hidden ${
                            isActivePage
            ...
            {/* All Settings Grid with Skeleton */}
            {loading ? (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex items-center gap-1.5">
                          {item.new && (
                            <span className="px-2 py-1 bg-gradient-to-r from-emerald-500 to-teal-500 text-white text-xs font-medium rounded-full">
                              New
                            </span>
                          )}
                          {item.badge && (
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="text-sm text-gray-600">
              <span className="font-medium text-blue-600">CRM System Settings</span>
