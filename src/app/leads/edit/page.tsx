...
export default function EditLeadPage() {
      ...
      <ProtectedRoute>
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">Please select a lead to edit.</p>
            <button
  ...
  return (
    <ProtectedRoute>
      <EditLeadForm 
        leadId={leadId}
        onBack={() => router.push(`/leads/details?id=${leadId}`)}
        onSave={() => router.push(`/leads/details?id=${leadId}`)}
      />
    </ProtectedRoute>
  );
}